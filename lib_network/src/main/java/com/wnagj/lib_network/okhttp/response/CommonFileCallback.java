package com.wnagj.lib_network.okhttp.response;

import android.os.Handler;
import android.os.Looper;
import android.os.Message;

import com.wnagj.lib_network.okhttp.exception.OkHttpException;
import com.wnagj.lib_network.okhttp.listener.DisposeDataHandle;
import com.wnagj.lib_network.okhttp.listener.DisposeDownloadListener;
...
public class CommonFileCallback implements Callback {
    ...
    protected final int IO_ERROR = -2; // JSON解析错误
   ...
   private DisposeDownloadListener mListener;
    private String mFilePath;//文件下载路径
